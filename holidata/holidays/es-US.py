...
class es_US(Locale):
    ...
    12-24: [RF] Nochebuena
    12-25: [NRF] Navidad
    3. monday in January: [V] Cumpleaños de Martin Luther King, Jr.
    3. monday in February: [NV] Día del Presidente
    3. monday in April: [MA,ME] [NV] Día del Patriota
    ...
    4. friday in November: [V] Día después de Acción de Gracias
    """
